...
export default class SchedulerData {
    constructor(date=moment().format(DATE_FORMAT), viewType = ViewTypes.Week,
                showAgenda = false, isEventPerspective = false, isResourcePlanner = false,
        ...
        this.cellUnit = viewType === ViewTypes.Day || ViewTypes.Decade ? CellUnits.Hour : CellUnits.Day;
        this.showAgenda = showAgenda;
        this.isEventPerspective = isEventPerspective;
        this.isResourcePlanner = isResourcePlanner;
        this.resizing = false;
    ...
    setViewType(viewType = ViewTypes.Week, showAgenda = false, isEventPerspective = false, isResourcePlanner = false) {
        this.showAgenda = showAgenda;
        this.isEventPerspective = isEventPerspective;
        ...
        if(this.viewType !== viewType) {
            ...
            if(viewType === ViewTypes.Custom || viewType === ViewTypes.Custom1 || viewType === ViewTypes.Custom2) {
                ...
                if(this.viewType < viewType){
                    ...
                    else if(viewType === ViewTypes.Decade){
                        this.startDate = this.localeMoment(date).format(DATE_FORMAT);
                        this.endDate = this.localeMoment(this.startDate).add(10, 'days').format(DATE_FORMAT);
                    }
    ...
    _resolveDate(num, date = undefined){
        ...
        else if(this.viewType === ViewTypes.Decade) {
    ...
    _createHeaders() {
        ...
        if(this.showAgenda){
        ...
        else if(this.isResourcePlanner){
            //ResourcePlanner
            while (header >= start && header <= end) {
                ...
                header.add(this.config.minuteStep, 'minutes');
            }          
            //console.log(headers)
    ...
    _createInitHeaderEvents(header) {
        ...
        let endValue = this.showAgenda ? (this.viewType === ViewTypes.Week ? start.add(1, 'weeks').format(DATETIME_FORMAT) :
         this.viewType === ViewTypes.Decade ? start.add(10, 'days').format(DATETIME_FORMAT) : (
    ...
    _createInitRenderData(isEventPerspective, isResourcePlanner, eventGroups, resources, headers) {
        let slots = isEventPerspective ? eventGroups : resources;
        //if (isResourcePlanner) slots = headers;
        let slotTree = [],
            slotMap = new Map();
        slots.forEach((slot) => {
        ...
        //console.log("_createInitRenderData");
        //console.log("slots", slots, "slotsTree", slotTree, "slotsMap", slotMap, "slotStack", slotStack);
    ...
    _createRenderData() {
        console.log("_createRenderData");
        let initRenderData = this._createInitRenderData(this.isEventPerspective, this.isResourcePlanner, this.eventGroups, this.resources, this.headers);
